...
class CommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadCommentsActions_requestCommentsFromLoader() {
        ...
        sut.simulateAppearance()
        XCTAssertEqual(loader.loadCommentsCallCount, 1, "Expected a loading requests before once view is loaded")
        ...
        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadCommentsCallCount, 3, "Expected yet another loading requests once user initiates another reload")
    }
